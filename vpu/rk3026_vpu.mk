...
sf_lib_3026spec_files := $(shell ls $(CUR_PATH)/lib2928spec | grep .so)
PRODUCT_COPY_FILES += \
       $(foreach file, $(sf_lib_3026spec_files), $(CUR_PATH)/lib2928spec/$(file):system/lib/$(file))

PRODUCT_COPY_FILES += \
       $(foreach file, $(sf_lib_3026spec_files), $(CUR_PATH)/lib2928spec/$(file):obj/lib/$(file))
...
PRODUCT_COPY_FILES += \
    ...
    device/rockchip/rk3188/vpu/lib/modules_rk3026/vpu_service.ko:system/lib/modules/vpu_service.ko
